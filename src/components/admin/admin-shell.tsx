...
const items = [
  ...
  { href: "/admin/content/skills-page", label: "Skills page" },
  { href: "/admin/content/roadmap-page", label: "Roadmap page" },
  { href: "/admin/content/certifications-page", label: "Certifications page" },
